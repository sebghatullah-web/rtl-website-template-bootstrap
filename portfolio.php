      ...
      <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-books">
          ...
          <div class="portfolio-info">
            ...
            <a href="assets/img/portfolio/books-1.jpg" title="کتاب 1" data-gallery="portfolio-gallery-book" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
            <a href="portfolio-details.html" title="جزئیات بیشتر" class="details-link"><i class="bi bi-link-45deg"></i></a>
          </div>
        </div><!-- پایان نمونه کار 4 -->
        ...
        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-books">
          ...
          <div class="portfolio-info">
            <h4>کتاب 2</h4>
            <p>لورم ایپسوم، درد sit amet consectetur</p>
            <a href="assets/img/portfolio/books-2.jpg" title="کتاب 2" data-gallery="portfolio-gallery-book" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
            <a href="portfolio-details.html" title="جزئیات بیشتر" class="details-link"><i class="bi bi-link-45deg"></i></a>
          </div>
        </div><!-- پایان نمونه کار 8 -->
        ...
        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-books">
          ...
          <div class="portfolio-info">
            <h4>کتاب 3</h4>
            <p>لورم ایپسوم، درد sit amet consectetur</p>
            <a href="assets/img/portfolio/books-3.jpg" title="کتاب 3" data-gallery="portfolio-gallery-book" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
            <a href="portfolio-details.html" title="جزئیات بیشتر" class="details-link"><i class="bi bi-link-45deg"></i></a>
          </div>
        </div><!-- پایان نمونه کار 12 -->

      </div><!-- پایان Container نمونه کارها -->

    </div>

  </div>

</section><!-- /بخش نمونه کارها -->
